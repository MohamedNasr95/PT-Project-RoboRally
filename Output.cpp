...
Output::Output()
{
	...
	UI.width = 1430; // make it divisible by NumHorizontalCells
	UI.height = 690; 
	UI.wx = 5;
	UI.wy = 5;
...
void Output::DrawTriangle(int triangleCenterX, int triangleCenterY, int triangleHeight, int triangleWidth, Direction direction, color triangleColor, drawstyle style, int penWidth) const
{
	...
	else if (direction == RIGHT) 
	{
		...
		x2 = triangleCenterX - triangleWidth / 2;
		y2 = triangleCenterY - triangleHeight / 2;
		x3 = triangleCenterX + triangleCenterX / 2;
		y3 = triangleCenterY;
	}
...
void Output::CreateCommandsBar(Command savedCommands[], int savedCommandsCount, Command availableCommands[], int availableCommandsCount) const
{
	...
	CommandItemImages[MOVE_FORWARD_ONE_STEP] = "images\\MoveForwardSingleStep.jpg";
	CommandItemImages[MOVE_BACKWARD_ONE_STEP] = "images\\MoveBackwardSingleStep.jpg";
	CommandItemImages[MOVE_FORWARD_TWO_STEPS] = "images\\MoveForwardDoubleStep.jpg";
	CommandItemImages[MOVE_BACKWARD_TWO_STEPS] = "images\\MoveBackwardDoubleStep.jpg";
	CommandItemImages[MOVE_FORWARD_THREE_STEPS] = "images\\MoveForwardTripleStep.jpg";
	CommandItemImages[MOVE_BACKWARD_THREE_STEPS] = "images\\MoveBackwardTripleStep.jpg";
	CommandItemImages[ROTATE_CLOCKWISE] = "images\\RotateClockwise.jpg";
...
Command Output::getRandomCommand() const {
	...
	return static_cast<Command>(dist(gen));
}
